...
class AdapterNotificacao (val fragment: ListaNotificacaoFragment): RecyclerView.Adapter<AdapterNotificacao.ViewHolderNotificacao>() {
    ...
    class ViewHolderNotificacao(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener{

        private val textViewResultado = itemView.findViewById<TextView>(R.id.textViewResultado)
        private val textViewNomeAlerta = itemView.findViewById<TextView>(R.id.textViewNomeAlerta)
        ...
        private fun seleciona() {
            ...
            DadosApp.notificacaoSelecionado = notificacao
            DadosApp.activity.atualizaMenuListaNotificacao(true)
        }
        ...
        companion object{
            var selecionado : ViewHolderNotificacao? = null
        }
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderNotificacao {
        val itemNotificacao = fragment.layoutInflater.inflate(R.layout.item_notificacao, parent, false)

        return ViewHolderNotificacao(itemNotificacao)
    }
