...
import android.provider.BaseColumns
 ...
 class TabelaDistritos(db: SQLiteDatabase) {
    private val db: SQLiteDatabase = db
    fun cria() {

        db.execSQL("CREATE TABLE ${NOME_TABELA} ( ${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, ${CAMPO_NOME_DISTRITO} TEXT NOT NULL)")
