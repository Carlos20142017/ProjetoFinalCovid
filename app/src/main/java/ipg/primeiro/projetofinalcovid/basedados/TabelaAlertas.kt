...
class TabelaAlertas (db: SQLiteDatabase){
    private val db: SQLiteDatabase = db
    fun cria() {

        db.execSQL("CREATE TABLE ${NOME_TABELA} ( ${BaseColumns._ID} INTEGER PRIMARY KEY AUTOINCREMENT, ${CAMPO_NOME_ALERTA} TEXT NOT NULL, ${CAMPO_DESCRICAO} TEXT NOT NULL)")
    ...
    companion object{
        ...
        val TODAS_COLUNAS = arrayOf(BaseColumns._ID, CAMPO_NOME_ALERTA, CAMPO_DESCRICAO)
    }
}